<section class="section-home-carousel-container">
        ...
        <div class="carousel-caption">
          <div class="row align-items-center">
            ...
            <div class="col-9 col-md-6">
              <h1 class="caption-title font-weight-bold text-left mx-3">Let’s make the internet safe for kids.</h1>
            </div>
          </div>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption">
          <div class="row align-items-center">
            ...
            <div class="col-9">
              <h1 class="caption-title font-weight-bold text-left mx-3">Help stop the online sexual abuse and exploitation of children.</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body">
              ...
              <ul class="card-list mb-5">
                ...
                <li class="card-list-check">Demand accountability of government. <br>
                  <a href="#">Sign the petition now</a>.</li>
                <li class="card-list-check">Stay safe online.</li>
                <li class="card-list-check">Follow SaferKidsPH on social media and share our content.</li>
              </ul>
          ...
          <div class="card card-texture">
            <div class="card-body">
              ...
              <ul class="card-list">
                ...
                <li><h5>Action Against Human Trafficking:</h5>
                  <p>1343 for Metro Manila</p>
        ...
        <div class="col-md-6 mb-5">
          <div class="card">
            ...
            <div class="card-img-overlay text-center d-flex flex-column justify-content-around">
              ...
              <p class="card-text h4 card-donate">With your donation, you can help rescue and protect children from online abuse.</p>
        ...
        <div class="col-md-6 mb-5">
          <div class="card">
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-around">
              <h3 class="card-title text-center h1 card-keep-safe">Keep your children safe online</h3>
